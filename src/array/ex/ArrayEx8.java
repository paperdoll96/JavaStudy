...
/*
    2차원 배열
    사용자로부터 학생의 수를 입력받아
     학생의 국어, 수학, 영어 점수를 입력받아 각 학생의총점과 평균을 계산
 */
public class ArrayEx8 {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        System.out.print("학생 수를 입력 하세요 : ");
        int studentCount = scanner.nextInt(); // 학생숫자 변수 선언



        int[][] scores = new int[studentCount][3]; // 입력받은 학생 숫자와 3과목(국어, 수학, 영어) 점수를 저장할 2차원 배열을 선언
        String[] subject = {"국어", "수학", "영어"}; // 과목명을 저장할 배열

        // 각 학생에 대한 점수 입력 받기
        for (int i = 0; i < studentCount; i++) { // 입력받은 학생 수만큼 반복
